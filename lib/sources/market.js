 ...
 *  Every candidate gets a community-trust tier (verified/established/community/new/archived). */
function dedupeRanked(list) {
  ...
  return [...repos, ...pkgs].map(c => ({
    ...c,
    trust: trustTier({ stars: c.rankKind === "stars" ? c.rank : 0, featured: !!c.featured, archived: !!c.archived }),
  }));
}
